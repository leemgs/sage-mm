...
\newcommand{\MeasurementAvailability}{The run-level measurement bundle (per-run values and bootstrap summaries) accompanies the manuscript under \texttt{paper/generated/evaluation-data/}.}
