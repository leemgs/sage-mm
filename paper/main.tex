...
On identical Raspberry~Pi~4 Model~B hardware---an official Tizen reference board
running the actual Tizen DTV platform---in 32- and 64-bit builds (a
controlled ISA comparison on one SoC) under a $512$\,MiB swapless budget, across
$30$ independent runs per condition, the fully coordinated design lowers
peak proportional set size by about $24\%$ and GC tail pause by $37$--$38\%$ under
a favorable workload---set by the static heap, interop, and reclamation
layers---while the online controller recovers most of the reclamation-induced
refaults at roughly $1\%$ controller CPU; the same design
...
indices from which the tables and figure in this section are generated; a fixed
