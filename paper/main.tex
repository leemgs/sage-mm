...
The Raspberry~Pi~4 Model~B serves as an open, reproducible memory-constrained ARM
stand-in for DTV/set-top-box firmware---the same class of quad-core Cortex-A
application processor, a cost-driven DRAM budget (here enforced by a cgroup
limit), and the same managed-runtime-on-Linux software stack---rather than a
production DTV; transfer to a specific vendor SoC is future validation
