...
On memory-constrained consumer-electronics devices such as digital TVs and
set-top boxes, SAGE-MM coordinates heap configuration, interop allocation, and
clean-page reclamation under a single process memory budget through a narrow,
safety-guarded online action, rather than tuning them in isolation: a
